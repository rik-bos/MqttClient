...
public class MqttPublish extends CustomJavaAction<java.lang.Boolean>
{
	...
	public java.lang.Boolean executeAction() throws Exception
	{
        ...
        try {
            handler.publish(this.BrokerHost, this.BrokerPort, this.BrokerOrganisation,this.TopicName, this.Payload, this.CA, this.ClientCertificate, this.ClientKey, this.CertificatePassword, this.Username, this.Password, this.QoS, this.Timeout, this.OverridingClientId, this.ForceSsl);
            return true;
        } catch (Exception e) {
            return false;
        }
