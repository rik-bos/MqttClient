...
package mqttclientcustomization.actions;
...
public class MqttSubscribe extends CustomJavaAction<java.lang.Boolean>
{
	...
	public MqttSubscribe(IContext context, java.lang.String BrokerHost, java.lang.Long BrokerPort, java.lang.String BrokerOrganisation, java.lang.Long Timeout, java.lang.String Username, java.lang.String Password, java.lang.String TopicName, java.lang.String OnMessageMicroflow, java.lang.String CA, java.lang.String ClientCertificate, java.lang.String ClientKey, java.lang.String CertificatePassword, java.lang.String QoS, java.lang.String OverridingClientId, java.lang.Boolean ForceSsl)
	{
		...
		this.OverridingClientId = OverridingClientId;
	...
	public java.lang.Boolean executeAction() throws Exception
	{
        ...
        try {
            ...
            handler.subscribe(this.BrokerHost, this.BrokerPort, this.BrokerOrganisation, this.TopicName, this.OnMessageMicroflow, this.CA, this.ClientCertificate, this.ClientKey, this.CertificatePassword, this.Username, this.Password, this.QoS, this.Timeout, this.OverridingClientId, this.ForceSsl);
            return true;
        } catch (Exception e) {
            return false;
        }		
